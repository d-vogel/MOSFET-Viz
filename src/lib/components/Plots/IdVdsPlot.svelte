<script lang="ts">
  ...
  import { VGS, VDS, Id, VdsSat } from '../../models/mosfet';
  ...
  function updatePlot() {
    ...
    // Add background rectangle for VdsSat label
    ...
    svgSelection.append('text')
      ...
      .text(`ID vs VDS (VGS = ${vgs.toFixed(2)}V)`);
  }
